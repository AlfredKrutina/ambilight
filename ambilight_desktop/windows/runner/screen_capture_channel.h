...
/// Registruje method channel `ambilight/screen_capture` (Windows: DXGI + GDI fallback, jedno perzistentní
/// worker vlákno s frontou — bez nového `std::thread` na každý snímek).
